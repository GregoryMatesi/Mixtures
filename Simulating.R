...
# At the end of every iteration of this loop will be printed the estimated pi-values, number of iterations, and time for both versions of SLSQP. An ouput matrix will also be appended with a new row for each iteration.

# The 3 source scripts needed to execute this code can be found at https://github.com/GregoryMatesi/SimulationDesign
...
for (i in 1:numberSims){
    ...
    print(i)    # Print number of iterations and current run time.
